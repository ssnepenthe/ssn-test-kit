...
class Browser {
	...
	public function request(
		...
		$this->client()->request(
			$method, $uri, $parameters, $files, $server, $content, $change_history
		);
	...
	public function get(
		...
		return $this->request(
			'GET', $uri, $parameters, $files, $server, $content, $change_history
		);
	}
	...
	public function post(
		...
		return $this->request(
			'POST', $uri, $parameters, $files, $server, $content, $change_history
		);
	}
